...
.to('.red', { duration: 0.5, transform: 'translateX(100%)'})
.to('.green', { duration: 0.5, transform: 'translateX(100%)'}, '<')
.to('.blue', { duration: 0.5, transform: 'translateX(-100%)'}, '<')
.to('.yellow', { duration: 0.5, transform: 'translateX(-100%)'}, '<')
